...
class acf_field_repeater extends acf_field {
	...
	*/
	...
	function input_admin_enqueue_scripts() {
		...
		// style, script
		wp_enqueue_style( 'acf-repeater-p', acf_repeater_url( 'media/repeater.min.css' ), acf_repeater_ver() );
		wp_enqueue_script( 'acf-repeater-p', acf_repeater_url( 'media/repeater.min.js' ), array('jquery'), acf_repeater_ver(), true );
	}
